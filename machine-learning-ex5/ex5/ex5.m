...
%% =========== Part 8: Learning Curve for Train Vs Cross validation Vs Test set =============
%  Graphically it was decided optimal lambda = 3 from learning curve.
%  The code below runs polynomial regression with lambda = 3.
%
